            ...
            sendMessage() {
                ...
                if(this.messageText != "") {
                    ...
                    this.$emit('messagesent',{
                        ...
                        name:this.$root.profile.name,
                        time:time,
                        avatar:this.$root.profile.avatar,//user.image_path,
                        type:'1',
                    });
                    axios.post('/messages/'+this.userId,data).then( response=> {
            ...
            onFlieChange(file) {
                ...
                if(files.length > 0) {
                    ...
                    if(this.validateFile(filesize,extension)) {
                        ...
                        axios.post('/fileUpload/'+this.userId,data).then( response=> {
                            this.emitMessage(response);
