            ...
            <div class="media">
                ...
                <div class="media-body">
                    ...
                    <span v-else-if="message.type == 4">
                        <a :href="'/files/'+message.file_path" download>
                            <img :src="'/files/'+message.file_path" style="max-width:500px">
                            <!-- {{ message.file_name }} -->
                        </a>
                    </span>
                    <span v-else>
                    ...
                    <br>
                   <small class="text-muted">{{ message.name }} &nbsp;|&nbsp; <i class="fa fa-clock-o"></i> &nbsp;{{ formatTime(message.time) }}</small>
                    <hr>
                </div>
            </div>
