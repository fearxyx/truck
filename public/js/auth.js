$('document').ready(function() {
    ...
    minHeight = hvidth - hFooter -1 - hHeader;
    ...
    $(window).resize(function() {
        ...
        hFooter = $('.footer ').height();
        minHeight = hvidth - hFooter - 1 - hHeader;
        $("#app").css("margin-top",hHeader);
        $("#app").css("min-height",minHeight+"!important" );
    });
    $("#app").css("margin-top",hHeader );
    $("#app").css("min-height",minHeight);
...
$('.closed').click(function() {
    $id = $(this).parent().parent().parent().siblings().show();
